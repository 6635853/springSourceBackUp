...
public class XmlBeanFactory extends DefaultListableBeanFactory {
	...
	public XmlBeanFactory(Resource resource, BeanFactory parentBeanFactory) throws BeansException {
		...
		/**
		 * @params [resource, parentBeanFactory]
		 * @return
		 * @throws
		 * @author csh
		 * @createTime 2020/5/11 9:40
		 * @description 在该方法中主要有三步
		 * 	1、对参数Resource进行EncodedResource封装
		 * 	2、获取输入流，从Resource 中获取对应的InputStream，并构造InputSource
		 * 	3、通过构造InputSource实例和Resource实例调用函数doLoadBeanDefinitions
		 */
