...
public class ResourceEditorRegistrar implements PropertyEditorRegistrar {
	 ...
	 * 使用下面的资源编辑器ResourceEditor，InputStreamEditor，InputSourceEditor，FileEditor，URLEditor，URIEditor，ClassEditor，ClassArrayEditor填充给定的{@code注册表}。如果此注册表配置了{@link ResourcePatternResolver}，
	 * ResourceArrayPropertyEditor也将被注册。
	 *
